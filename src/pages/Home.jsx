...
export default function Home() {
  ...
  return (
    <div className="home">
      <Seo
        title="Вейп шоп в Орше — «Облако Пара»"
        description="Ищете вейп шоп в Орше? «Облако Пара» — магазин электронных парогенераторов: POD-системы, жидкости, одноразки, паучи и кальянные смеси. Онлайн-бронирование и консультация."
        canonicalPath="/"
        ogType="website"
      />
      <h1 className="home-seo-h1">Вейп шоп в Орше — магазин «Облако Пара»</h1>
      <HeroCarousel />
